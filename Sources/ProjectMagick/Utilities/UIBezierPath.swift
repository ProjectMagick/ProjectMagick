...
public extension UIBezierPath {
    ...
    /// ProjectMagick: Initializes a UIBezierPath with a line from a CGPoint to another CGPoint.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Initializes a UIBezierPath connecting the given CGPoints with straight lines.
    ///
    ...
    /// ProjectMagick: Initializes a polygonal UIBezierPath with the given CGPoints. At least 3 points must be given.
    ///
    ...
    /// ProjectMagick: Initializes a UIBezierPath with an oval path of given size.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Initializes a UIBezierPath with a  rectangular path of given size.
    ///
    /// - Parameters:
