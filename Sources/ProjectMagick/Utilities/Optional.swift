...
public extension Optional {
    ...
    /// ProjectMagick: Get self of default value (if self is nil).
    ///
    ///        let foo: String? = nil
    ...
    /// ProjectMagick: Gets the wrapped value of an optional. If the optional is `nil`, throw a custom error.
    ///
    ///        let foo: String? = nil
    ...
    /// ProjectMagick: Runs a block to Wrapped if not nil
    ///
    ///        let foo: String? = nil
    ...
    /// ProjectMagick: Assign an optional value to a variable only if the value is not nil.
    ///
    ...
    /// ProjectMagick: Assign an optional value to a variable only if the variable is nil.
    ///
...
public extension Optional where Wrapped: Collection {
    ...
    /// ProjectMagick: Check if optional is nil or empty collection.
    var isNilOrEmpty: Bool {
        guard let collection = self else { return true }
        return collection.isEmpty
    }

    /// ProjectMagick: Returns the collection only if it is not nill and not empty.
