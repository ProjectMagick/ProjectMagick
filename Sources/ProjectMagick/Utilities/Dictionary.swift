...
public extension Dictionary {
    ...
    /// ProjectMagick: Creates a Dictionary from a given sequence grouped by a given key path.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Check if key exists in dictionary.
    ///
    ...
    /// ProjectMagick: Remove all keys contained in the keys parameter from the dictionary.
    ///
    ...
    /// ProjectMagick: Remove a value for a random key from the dictionary.
    @discardableResult
    ...
    /// ProjectMagick: JSON Data from dictionary.
    ///
    ...
    #if canImport(Foundation)
    /// ProjectMagick: JSON String from dictionary.
    ///
    ...
    /// ProjectMagick: Returns a dictionary containing the results of mapping the given closure over the sequence’s elements.
    ...
    /// ProjectMagick: Returns a dictionary containing the non-`nil` results of calling the given transformation with each element of this sequence.
    ...
    /// ProjectMagick: Creates a new dictionary using specified keys.
    ///
...
public extension Dictionary where Value: Equatable {
    ...
    /// ProjectMagick: Returns an array of all keys that have the given value in dictionary.
    ///
...
public extension Dictionary where Key: StringProtocol {
    ...
    /// ProjectMagick: Lowercase all keys in dictionary.
    ///
...
public extension Dictionary {
    ...
    /// ProjectMagick: Deep fetch or set a value from nested dictionaries.
    ///
...
public extension Dictionary {
    ...
    /// ProjectMagick: Merge the keys/values of two dictionaries.
    ///
    ...
    /// ProjectMagick: Append the keys and values from the second dictionary into the first one.
    ///
    ...
    /// ProjectMagick: Remove keys contained in the sequence from the dictionary
    ///
