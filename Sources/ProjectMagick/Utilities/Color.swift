...
public extension Color {
    ...
    /// ProjectMagick: RGB components for a Color (between 0 and 255).
    ///
    ...
    // swiftlint:disable large_tuple
    /// ProjectMagick: RGB components for a Color represented as CGFloat numbers (between 0 and 1)
    ///
    ...
    // swiftlint:disable large_tuple
    /// ProjectMagick: Get components of hue, saturation, and brightness, and alpha (read-only).
    ...
    /// ProjectMagick: Hexadecimal value string (read-only).
    ...
    /// ProjectMagick: Short hexadecimal value string (read-only, if applicable).
    ...
    /// ProjectMagick: Short hexadecimal value string, or full hexadecimal string if not possible (read-only).
    ...
    /// ProjectMagick: Alpha of Color (read-only).
    var alpha: CGFloat {
        return cgColor.alpha
    }

    #if !os(watchOS)
    /// ProjectMagick: CoreImage.CIColor (read-only)
    var coreImageColor: CoreImage.CIColor? {
        return CoreImage.CIColor(color: self)
    }
    #endif

    /// ProjectMagick: Get UInt representation of a Color (read-only).
    var uInt: UInt {
        let comps: [CGFloat] = {
            let comps = cgColor.components!
    ...
    /// ProjectMagick: Get color complementary (read-only, if applicable).
...
public extension Color {
    ...
    /// ProjectMagick: Blend two Colors
    ///
    /// - Parameters:
...
public extension Color {
    ...
    /// ProjectMagick: Create Color from RGB values with optional transparency.
    ///
    /// - Parameters:
    ///   - red: red component.
    ...
    /// ProjectMagick: Create Color from hexadecimal value with optional transparency.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Create Color from hexadecimal string with optional transparency (if applicable).
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Create Color from a complementary of a Color (if applicable).
    ///
...
public extension Color {
    ...
    /// ProjectMagick: Brand identity color of popular social media platform.
    struct Social {
