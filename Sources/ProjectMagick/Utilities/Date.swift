...
public extension Date {
    ...
    /// ProjectMagick: Month name format.
    ///
...
public extension Date {
    ...
    /// ProjectMagick: User’s current calendar.
    ...
    /// ProjectMagick: Check if date is in future.
    ///
    ...
    /// ProjectMagick: Check if date is in past.
    ///
    ...
    /// ProjectMagick: Check if date is within today.
    ///
    ///     Date().isInToday -> true
    ///
    var isInToday: Bool {
    ...
    /// ProjectMagick: Check if date is within yesterday.
    ///
    ...
    /// ProjectMagick: Check if date is within tomorrow.
    ///
    ...
    /// ProjectMagick: Check if date is within a weekend period.
    var isInWeekend: Bool {
        return calendar.isDateInWeekend(self)
    }

    /// ProjectMagick: Check if date is within a weekday period.
    var isWorkday: Bool {
        return !calendar.isDateInWeekend(self)
    }

    /// ProjectMagick: Check if date is within the current week.
    var isInCurrentWeek: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
    }

    /// ProjectMagick: Check if date is within the current month.
    var isInCurrentMonth: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .month)
    }

    /// ProjectMagick: Check if date is within the current year.
    var isInCurrentYear: Bool {
        return calendar.isDate(self, equalTo: Date(), toGranularity: .year)
    }

    /// ProjectMagick: ISO8601 string of format (yyyy-MM-dd'T'HH:mm:ss.SSS) from date.
    ///
    ...
    /// ProjectMagick: Nearest five minutes to date.
    ///
    ...
    /// ProjectMagick: Nearest ten minutes to date.
    ///
    ...
    /// ProjectMagick: Nearest quarter hour to date.
    ///
    ///     var date = Date() // "5:57 PM"
    ///     date.minute = 34 // "5:34 PM"
    ...
    /// ProjectMagick: Nearest half hour to date.
    ///
    ...
    /// ProjectMagick: Nearest hour to date.
    ///
    ...
    /// ProjectMagick: UNIX timestamp from date.
    ///
...
public extension Date {
    ...
    /// ProjectMagick: Date by adding multiples of calendar component.
    ///
    ...
    /// ProjectMagick: Add calendar component to date.
    ///
    ...
    /// ProjectMagick: Date by changing value of calendar component.
    ///
    ///     let date = Date() // "Jan 12, 2017, 7:07 PM"
    ...
    /// ProjectMagick: Data at the beginning of calendar component.
    ///
    ...
    /// ProjectMagick: Date at the end of calendar component.
    ///
    ...
    /// ProjectMagick: Check if date is in current given calendar component.
    ///
    ...
    /// ProjectMagick: Date string from date.
    ///
    ...
    /// ProjectMagick: Date and time string from date.
    ///
    ...
    /// ProjectMagick: Time string from date
    ///
    ...
    /// ProjectMagick: Day name from date.
    ///
    ...
    /// ProjectMagick: Month name from date.
    ///
    ...
    /// ProjectMagick: get number of seconds between two date
    ///
    ...
    /// ProjectMagick: get number of minutes between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// ProjectMagick: get number of hours between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// ProjectMagick: get number of days between two date
    ///
    /// - Parameter date: date to compate self to.
    ...
    /// ProjectMagick: check if a date is between two other dates
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: check if a date is a number of date components of another date
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Returns a random date within the specified range.
    ///
    ...
    /// ProjectMagick: Returns a random date within the specified range, using the given generator as a source for randomness.
    ///
    /// - Parameters:
...
public extension Date {
    ...
    /// ProjectMagick: Create a new date form calendar components.
    ///
    ...
    /// ProjectMagick: Create date object from ISO8601 string.
    ///
    ...
    /// ProjectMagick: Create new date object from UNIX timestamp.
    ///
    ...
    /// ProjectMagick: Create date object from Int literal
    ///
