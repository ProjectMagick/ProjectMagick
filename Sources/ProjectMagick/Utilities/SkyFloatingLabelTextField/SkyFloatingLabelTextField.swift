...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    /// A UIColor value that determines text color of the placeholder label
     ...
     dynamic open var lineVerticalSpacing: CGFloat = 0 {
        didSet {
            setNeedsDisplay()
        }
    }
    
     dynamic open var titleVerticalSpacing: CGFloat = 0 {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        var height = superRect.size.height - titleHeight - selectedLineHeight - lineVerticalSpacing
    ...
    override open func placeholderRect(forBounds bounds: CGRect) -> CGRect {
        var height = bounds.size.height - titleHeight() - selectedLineHeight - lineVerticalSpacing
        if errorMessagePlacement == .bottom {
            height -= errorHeight()
        }
        let rect = CGRect(
