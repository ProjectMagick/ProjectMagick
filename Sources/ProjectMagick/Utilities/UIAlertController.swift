...
public extension UIAlertController {
    ...
    /// ProjectMagick: Present alert view controller in the current view controller.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Add an action to Alert
    ///
    /// - Parameters:
    ///   - title: action title
    ...
    /// ProjectMagick: Add a text field to Alert
    ///
    /// - Parameters:
...
public extension UIAlertController {
    ...
    /// ProjectMagick: Create new alert view controller with default OK action.
    ///
    /// - Parameters:
    ...
    convenience init(title: String, message: String? = nil, defaultActionButtonTitle: String = SmallTitles.ok, tintColor: UIColor? = nil) {
    ...
    /// ProjectMagick: Create new error alert view controller from Error with default OK action.
    ///
    /// - Parameters:
    ...
    ///   - defaultActionButtonTitle: default action button title (default is "OK")
    ///   - tintColor: alert controller's tint color (default is nil)
    convenience init(title: String = "Error", error: Error, defaultActionButtonTitle: String = SmallTitles.ok, preferredStyle: UIAlertController.Style = .alert, tintColor: UIColor? = nil) {
