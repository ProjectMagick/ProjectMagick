...
public enum TTGSnackbarDuration: Int {
    case short = 1
    case middle = 3
    case long = 5
...
public enum TTGSnackbarAnimationType: Int {
    case fadeInFadeOut
...
open class TTGSnackbar: UIView {
    ...
    /// Snackbar min height
    public static var snackbarMinHeight: CGFloat = DeviceDetail.isIPhone ? 44 : 80
    ...
    /// Tap callback
    open var onTapBlock: TTGActionBlock?
    
    /// Swipe callback
    open var onSwipeBlock: TTGSwipeBlock?
    ...
    /// Second action block
    open var secondActionBlock: TTGActionBlock? = nil
    ...
    open var animationType: TTGSnackbarAnimationType = TTGSnackbarAnimationType.slideFromBottomBackToBottom
    ...
    open var rightMargin: CGFloat = 4 {
        didSet {
    ...
    open var bottomMargin: CGFloat = 4 {
        didSet {
    ...
    open var contentInset: UIEdgeInsets = UIEdgeInsets.init(top: 0, left: 4, bottom: 0, right: 4) {
        didSet {
    ...
    open var messageTextFont: UIFont = UIFont.boldSystemFont(ofSize: 14) {
        didSet {
    ...
    open var messageTextAlign: NSTextAlignment = .left {
        didSet {
    ...
    open var actionTextColor: UIColor = UIColor.white {
        didSet {
    ...
    open var secondActionTextColor: UIColor = UIColor.white {
        didSet {
    ...
    open var separateViewBackgroundColor: UIColor = UIColor.gray {
        didSet {
...
public extension TTGSnackbar {
    ...
    func show() {
        ...
        if let superView = containerView ?? UIApplication.shared.windows.first(where: { $0.isKeyWindow }) {
