...
public extension URL {
    ...
    /// ProjectMagick: Dictionary of the URL's query parameters
...
public extension URL {
    ...
    /// ProjectMagick: URL with appending query parameters.
    ///
    ...
    /// ProjectMagick: Append query parameters to URL.
    ///
    ...
    /// ProjectMagick: Get value of a query key.
    ///
    ...
    /// ProjectMagick: Returns a new URL by removing all the path components.
    ///
    ...
    /// ProjectMagick: Remove all the path components from the URL.
    ///
    ...
    /// ProjectMagick: Generates new URL that does not have scheme.
    ///
...
public extension URLRequest {
    ...
    /// ProjectMagick: Create URLRequest from URL string.
    ///
