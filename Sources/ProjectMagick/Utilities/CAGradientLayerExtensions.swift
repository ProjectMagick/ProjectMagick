// CAGradientLayerExtensions.swift - Copyright 2020 ProjectMagick

#if !os(watchOS) && !os(Linux) && canImport(QuartzCore)
import QuartzCore

public extension CAGradientLayer {
    /// ProjectMagick: Creates a CAGradientLayer with the specified colors, location, startPoint, endPoint, and type.
    ///
    /// - Parameters:
