...
public extension CGSize {
    ...
    /// ProjectMagick: Returns the aspect ratio.
    var aspectRatio: CGFloat {
        return height == 0 ? 0 : width / height
    }

    /// ProjectMagick: Returns width or height, whichever is the bigger value.
    var maxDimension: CGFloat {
        return max(width, height)
    }

    /// ProjectMagick: Returns width or height, whichever is the smaller value.
...
public extension CGSize {
    ...
    /// ProjectMagick: Aspect fit CGSize.
    ///
    ...
    /// ProjectMagick: Aspect fill CGSize.
    ///
...
public extension CGSize {
    ...
    /// ProjectMagick: Add a tuple to CGSize.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ...
    /// ProjectMagick: Add a CGSize to self.
    ///
    ...
    /// ProjectMagick: Add a tuple to self.
    ///
    ///     var sizeA = CGSize(width: 5, height: 10)
    ///     sizeA += (3, 4)
    ///     // result = CGSize(width: 8, height: 14)
    ...
    /// ProjectMagick: Subtract two CGSize.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     let result = sizeA - sizeB
    ...
    /// ProjectMagick: Subtract a tuple from CGSize.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ...
    /// ProjectMagick: Subtract a CGSize from self.
    ///
    ///     var sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     sizeA -= sizeB
    ...
    /// ProjectMagick: Subtract a tuple from self.
    ///
    ///     var sizeA = CGSize(width: 5, height: 10)
    ///     sizeA -= (2, 4)
    ...
    /// ProjectMagick: Multiply two CGSize.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     let result = sizeA * sizeB
    ...
    /// ProjectMagick: Multiply a CGSize with a scalar.
    ///
    ///     let sizeA = CGSize(width: 5, height: 10)
    ///     let result = sizeA * 5
    ...
    /// ProjectMagick: Multiply self with a CGSize.
    ///
    ///     var sizeA = CGSize(width: 5, height: 10)
    ///     let sizeB = CGSize(width: 3, height: 4)
    ///     sizeA *= sizeB
    ...
    /// ProjectMagick: Multiply self with a scalar.
    ///
    ///     var sizeA = CGSize(width: 5, height: 10)
    ///     sizeA *= 3
