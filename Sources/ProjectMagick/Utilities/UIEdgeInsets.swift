...
public extension UIEdgeInsets {
    /// ProjectMagick: Return the vertical insets. The vertical insets is composed by top + bottom.
    ///
    var vertical: CGFloat {
        // Source: https://github.com/MessageKit/MessageKit/blob/master/Sources/ProjectMagick/UIEdgeInsets%2BExtensions.swift
        return top + bottom
    }

    /// ProjectMagick: Return the horizontal insets. The horizontal insets is composed by  left + right.
    ///
...
// MARK: - Methods
public extension UIEdgeInsets {
    /// ProjectMagick: Creates an `UIEdgeInsets` with the inset value applied to all (top, bottom, right, left)
    ///
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` with the horizontal value equally divided and applied to right and left.
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and top offset.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and left offset.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and bottom offset.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and right offset.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and horizontal value equally divided and applied to right offset and left offset.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Creates an `UIEdgeInsets` based on current value and vertical value equally divided and applied to top and bottom.
    ///
    /// - Parameters:
...
public extension UIEdgeInsets {
    ...
    /// ProjectMagick: Add all the properties of two `UIEdgeInsets` to create their addition.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Add all the properties of two `UIEdgeInsets` to the left-hand instance.
    ///
    /// - Parameters:
