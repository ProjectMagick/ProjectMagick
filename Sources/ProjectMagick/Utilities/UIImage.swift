...
public extension UIImage {
    ...
    /// ProjectMagick: Size in bytes of UIImage
    var bytesSize: Int {
        return jpegData(compressionQuality: 1)?.count ?? 0
    }

    /// ProjectMagick: Size in kilo bytes of UIImage
    var kilobytesSize: Int {
        return bytesSize / 1024
    }

    /// ProjectMagick: UIImage with .alwaysOriginal rendering mode.
    var original: UIImage {
        return withRenderingMode(.alwaysOriginal)
    }

    /// ProjectMagick: UIImage with .alwaysTemplate rendering mode.
...
public extension UIImage {
    ...
    /// ProjectMagick: Compressed UIImage from original UIImage.
    ///
    ...
    /// ProjectMagick: Compressed UIImage data from original UIImage.
    ///
    /// - Parameter quality: The quality of the resulting JPEG image, expressed as a value from 0.0 to 1.0. The value 0.0 represents the maximum compression (or lowest quality) while the value 1.0 represents the least compression (or best quality), (default is 0.5).
    ...
    /// ProjectMagick: UIImage Cropped to CGRect.
    ///
    ...
    /// ProjectMagick: UIImage scaled to height with respect to aspect ratio.
    ///
    /// - Parameters:
    ///   - toHeight: new height.
    ...
    /// ProjectMagick: UIImage scaled to width with respect to aspect ratio.
    ///
    /// - Parameters:
    ///   - toWidth: new width.
    ///   - opaque: flag indicating whether the bitmap is opaque.
    ...
    /// ProjectMagick: Creates a copy of the receiver rotated by the given angle.
    ///
    ...
    /// ProjectMagick: Creates a copy of the receiver rotated by the given angle (in radians).
    ///
    ///     // Rotate the image by 180°
    ///     image.rotated(by: .pi)
    ///
    ...
    /// ProjectMagick: UIImage filled with color
    ///
    ...
    /// ProjectMagick: UIImage tinted with color
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: UIImage with rounded corners
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Base 64 encoded PNG data of the image.
    ///
    ...
    /// ProjectMagick: Base 64 encoded JPEG data of the image.
    ///
    ...
    /// ProjectMagick: UIImage with color uses .alwaysOriginal rendering mode.
    ///
    /// - Parameters:
...
public extension UIImage {
    ...
    /// ProjectMagick: Create UIImage from color and size.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Create a new image from a base 64 string.
    ///
    /// - Parameters:
    ...
    /// ProjectMagick: Create a new image from a URL
    ///
    /// - Important:
